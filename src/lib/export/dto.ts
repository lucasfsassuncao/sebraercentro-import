...
export interface ConsultoriaExportDTO {
  ...
  cpfConsultor: string;        // CPF, apenas dígitos
...
export const EXPORT_COLUMNS: {
  ...
  { header: "Cod_disponibilizacao", key: "codDisponibilizacao", width: 20, type: "text" },
  { header: "Documento_cliente",    key: "documentoCliente",    width: 18, type: "text" },
  { header: "Documento_empresa",    key: "documentoEmpresa",    width: 20, type: "text" },
  ...
  { header: "Cod_meio_atendimento", key: "codMeioAtendimento",  width: 18, type: "text" },
